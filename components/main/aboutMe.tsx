...
export const AboutMe = () => {
  return (
    ...
    >
      ...
      >
        <motion.div
          className="w-64 h-72 sm:w-80 sm:h-96 md:w-96 md:h-[450px] lg:w-[380px] lg:h-[450px] xl:w-[420px] xl:h-[480px] overflow-hidden rounded-2xl shadow-lg"
          whileHover={{
            scale: 1.02,
      ...
      <motion.div
        ...
        className="flex flex-col gap-4 sm:gap-5 lg:gap-6 text-center lg:text-left max-w-full lg:max-w-2xl order-1 lg:order-2"
      >
        <motion.h2
        ...
        <motion.p
          variants={staggerItem}
          className="text-gray-400 text-sm sm:text-base lg:text-lg leading-relaxed max-w-full sm:max-w-[500px] mx-auto lg:mx-0 px-2 sm:px-0"
        >
          I am a{" "}
          <motion.span
