...
export const PROJECTS = [
  ...
  },
  {
    ...
    description:
      "A modern, responsive grocery management app built with Next.js, Node.js, Express, MongoDB, and Tailwind CSS. Users can log in, browse products, manage cart, add addresses, place orders, and view order history. Sellers can manage inventory through an admin panel.",
    tags: [
      "Next.js",
      "Node.js",
      "Express.js",
    ...
    github: "https://github.com/Anirudh-Singh-26/ZipCart_Frontend",
    webapp: "https://zip-cart-frontend.vercel.app/",
  },
  {
  ...
  },
  {
    ...
    image: "/projects/Anirudh-Singh-Rathore-Space-Portfolio.png",
    description:
      "A sleek and responsive personal portfolio website built to showcase projects, skills, and achievements. Features modern UI/UX, smooth animations, and easy navigation to highlight developer work effectively.",
    tags: ["Next.js", "React", "Tailwind CSS", "Responsive UI", "Animations"],
    github: "https://github.com/Anirudh-Singh-26/Galaxy_Portfoli",
    webapp: "https://galaxy-portfoli.vercel.app/",
  },
];
